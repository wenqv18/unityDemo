...
/// <summary>
/// Ranged summon combat brain. It shares summon targeting and uses RangedAttackBehaviour
/// for projectile delivery.
/// </summary>
public sealed class RangedSummonAI : MonoBehaviour, ICharacterAnimationStateProvider
{
